...
if __name__ == "__main__":
    ...
    if args.data_set == 'MNIST' :
        ...
        train_loader = DataLoader(
            MNIST_train, batch_size = args.batch_size, shuffle = True, num_workers = args.num_workers
        )
        test_loader = DataLoader(
            MNIST_test, batch_size = args.batch_size, shuffle = False, num_workers = args.num_workers
        )
        ...
        train_loader = DataLoader(
            CIFAR10_train, batch_size = args.batch_size, shuffle=True, num_workers= args.num_workers
        )
        test_loader = DataLoader(
            CIFAR10_test, batch_size = args.batch_size, shuffle=False, num_workers= args.num_workers
        )
